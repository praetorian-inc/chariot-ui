    ...
    <div className="flex min-h-screen flex-col space-y-6">
      ...
      <div className="rounded-[2px] bg-white p-6 shadow-md">
        ...
        <p className="mb-4 text-gray-700">
          Critical and high-risk findings pose a material risk to the security
          of the client's most important assets, and should be prioritized for
          remediation. Praetorian identified the following critical and
          high-risk findings during the course of the engagement.
        </p>
          ...
          <div className="border-l-4 border-red-600 pl-4">
            <div className="mt-2">
              ...
              <p className="text-gray-700">
                Praetorian identified a flaw in the email verification process
                for password resets in certain versions of GitLab, allowing an
                attacker to manipulate passwords and take over user accounts. An
                attacker exploiting this vulnerability could take over any
                account on the server, posing a significant security risk.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-4 border-yellow-600 pl-4">
            <div className="mt-2">
              ...
              <p className="text-gray-700">
                ...
                information, although reloading the device will restore the
                files.
              </p>
            </div>
            ...
            <div className="mt-2">
              ...
              <p className="text-gray-700">
                ...
                detailed error messages could potentially contain information
                that might be leveraged by an attacker in a more impactful
                attack.
              </p>
            </div>
      ...
      <div className="rounded-[2px] bg-white p-6 shadow-md">
        ...
        <p className="mb-4 text-gray-700">
          Praetorian advises {client_short} to immediately upgrade to the fixed
          GitLab CE and EE versions to mitigate the account takeover
        ...
        <ul className="ml-4 list-inside list-disc text-gray-700">
          <li className="mb-2">
            ...
            patched version as per Cisco's security advisory to address the path
          ...
          <li className="mb-2">
            Praetorian recommends that {client_short} secure metric pages behind
            an identity-aware proxy or corporate VPN to protect the exposed
            Kubelet metrics endpoint.
          </li>
          <li className="mb-2">
            Praetorian recommends that {client_short} update the affected Apache
            HTTP Server to version 2.4.41 or later to mitigate the HTML
            injection and partial cross-site scripting vulnerability.
          </li>
          <li className="mb-2">
            Praetorian advises {client_short} to set the NODE_ENV variable to
            "production" for internet-exposed Express applications to disable
            development mode.
          </li>
          <li className="mb-2">
      ...
      <div className="rounded-[2px] bg-white p-6 shadow-md">
        ...
        <p className="mb-4 text-gray-700">
          ...
          vulnerabilities that could significantly impact the client's business.
          The most severe finding involves a flaw in the GitLab email
          verification process for password resets, allowing a potential
          attacker to take over user accounts. This vulnerability presents
          considerable risk, as unauthorized access to accounts could lead to
          data breaches, loss of sensitive information, and potential legal and
          financial repercussions. Immediate action to upgrade GitLab or
          implement restrictive measures for email domains is crucial to
        ...
        <p className="text-gray-700">
          ...
          concerns, such as the public accessibility of a Prometheus exporter
          and an exposed Kubelet metrics endpoint, which could provide attackers
          with valuable information to enhance their attacks. Additional
          ...
          cross-site scripting, or leakage of detailed error messages.
          Addressing these vulnerabilities by updating to latest software
          versions and implementing recommended security practices will enhance
